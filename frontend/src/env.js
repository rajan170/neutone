...
export const env = createEnv({
  ...
  server: {
    ...
    AWS_ACCESS_KEY_: z.string(),
    AWS_SECRET_ACCESS_KEY_: z.string(),
    AWS_REGION: z.string(),
    S3_BUCKET_NAME: z.string(),
    GENERATE_FROM_DESCRIPTION_ENDPOINT: z.string(),
    GENERATE_FROM_DESCRIBED_LYRICS_ENDPOINT: z.string(),
    GENERATE_FROM_LYRICS_ENDPOINT: z.string(),
